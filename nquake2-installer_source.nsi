...
;By Empezar 2012-12-09; Last modified 2013-01-01
...
!define NQUAKE2_URL "http://nquake.sourceforge.net" # Note: no trailing slash! - for nquake2.ini downloading
!define INSTALLER_URL "http://nquake.com/2" # Note: no trailing slash! - for visiting nQuake2 website
